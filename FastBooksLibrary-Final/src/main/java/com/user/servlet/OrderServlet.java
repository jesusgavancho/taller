...
public class OrderServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			// testing
			// xct1 xct1@gmail.com 987654329 3794 Pretty View Lane,Near Golden Gate
			// Bridge,San Francisco,CA,94103 COD
			...
			if (blist.isEmpty()) {
				...
				for (Cart c : blist) {
					...
					// Ethical Hacking Brian Walker 80.0
					// Linux Command-Line Dylan Mach 50.0
					// IA Initiate Jhon Darryl 80.0
					o = new Book_Order();
