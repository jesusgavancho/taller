...
<!-- using font-awesome to my icons -->
<!-- using color-materialize to select my colors  -->
...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa fa-book"></i> FastBooksLibrary
			</h3>
		</div>
		<div class="col-md-6">
			<form class="form-inline my-2 my-lg-0" action="search.jsp" method="post">
				<input class="form-control mr-sm-2" type="search" name="sch"
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<a href="help_center.jsp" class="btn btn-light my-2 my-sm-0 ml-2" type="submit">
